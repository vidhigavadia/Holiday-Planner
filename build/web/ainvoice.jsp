            ...
            <div class="main_resize">
                ...
                <div class="content" style="min-height: 500px">
                    <div class="content_bg">
                        <div class="mainbar">
                            <div class="article">
                                <h2 align="left">View generated invoices.</h2>
                                <h3>  ${Status} </h3>
                                    ...
                                    <c:if test="${InvList.size() > 0}">
                                        <table class="addtable" border="1" width="100%">
                                            ...
                                            <tbody>
												...
												<tr>
                                                <td align="center"><input type="radio" name="invid" value="${i.inv_id}" checked="checked"/></td>
                                                <td align="center">${i.vendorname}</td>
                                                <td align="center">${i.amt}</td>
