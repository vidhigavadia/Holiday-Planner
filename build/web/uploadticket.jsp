    ...
    <head>
        ...
        <script type="text/javascript">
            function chkf()
            {
                ...
                var s = fname.substring(fname.length - 4, fname.length)
                ...
                document.getElementById("err").innerHTML="Select .zip/.rar file."
                        ...
                        <div class="mainbar">
                            <div class="article">
                                ...
                                <form action="UploadServlet" method="post" enctype="multipart/form-data">
                                    <label>You can upload only one file per trip. So to upload multiple files use compression tools like WinRAR to combine them into one file. Then select that compresses/combined file here.</label>
                                    <br>
                                    <label><b>Only .zip/.rar file is supported.</b></label>
                                    <br>

                                    <p>
                                        <input type="file" name="file" id="finame"/>

                                    </p>
                                    <div id="err" ></div>
                                    <p>

                                        <input type="submit" value="Upload Ticket" name="vst" onclick="return chkf();" />
                                    </p>
