<%-- 
    Document   : vtrip
    Created on : Apr 14, 2014, 6:05:37 PM
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${Subtrip}" var="Submittedtrip">
                                                <tr>
                                                    ...
                                                    <td align="center"><input type="radio" name="tripid" value="${Submittedtrip.tripId}" checked="true"/></td>
                                            ...
                                            <p> <input type="submit" value="Get Info" name="vst"/>
                                                <input type="submit" value="Submit Quotation" name="vst" />
                                    </p>
                                    </c:if>
