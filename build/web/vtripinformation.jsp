<%-- 
    Document   : vtripinformation
    Created on : Apr 14, 2014, 6:32:31 PM
                ...
                <div class="header">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li><a href="vlogout">Log out</a></li>
                        </ul>
                        <div class="clr"></div>
                    </div>
                    ...
                    <div class="content_bg">
                        <div class="mainbar">
                            <div class="article">
                                <h2>Trip Details </h2>
                                <div class="clr"></div>
                                <p><div align="center"><h3>Trip Name: ${TripDetail.tripname}</h3></div></p>
                        ...
                        <div class="sidebar">
                            <div class="gadget">
                                ...
                                <ul class="sb_menu">
                                    ...
                                    <li><a href="QuotedTripServlet">View Quoted Trip</a></li>
                                    <li><a href="ApprovedTripServlet">View Approved Trip</a></li>
                                    <li><a href="bookedtrip.jsp">View Booked Trip </a></li>
