                ...
                <div class="header">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li><a href="avendor.jsp">User</a></li>
                    ...
                    <div class="content_bg">
                            ...
                            <div class="article">
                                ...
                                <form action="EditServlet" method="post">
                                    <table width="100%" height="229">
                                        ...
                                        <td><p><c:if test="${ProfileInfo.gender == 'male'}" >
                                                    <label>
                                        ...
                                        <td><input type="text" name="street" id="street" placeholder="Street" disabled="disabled" value="${ProfileInfo.street}"></td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><div align="left"><span class="style5"><span class="style5"></span></span></div></th>
                                        <td><input type="text" name="city" id="city" placeholder="City" disabled="disabled" value="${ProfileInfo.city}">
                                            <input type="text" name="pincode" placeholder="Pincode" id="pincode" disabled="disabled" value="${ProfileInfo.pincode}"></td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><div align="left"><span class="style5"><span class="style5"></span></span></div></th>
                                        <td><input type="text" name="state" id="state" placeholder="State" disabled="disabled" value="${ProfileInfo.state}"></td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><div align="left" class="style5">Phone No. </div></th>
                                        <td><input type="text" name="phno" id="phno" placeholder="Phone No" disabled="disabled" value="${ProfileInfo.phno}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="sidebar">
                            <div class="gadget">
                                ...
                                <ul class="sb_menu">
                                    <li class="active"><a href="SetProfileServlet">Profile</a></li>
                                    <li><a href="achangepassword.jsp">Change Password</a></li>
                                    <li><a href="LogOutServlet">Log out</a></li>
