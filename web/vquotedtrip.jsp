<%-- 
    Document   : vquotedtrip
    Created on : Apr 14, 2014, 6:29:06 PM
                                    ...
                                    <c:if test="${Quotes.size() > 0}">
                                        <table border-style="solid" border="1" class="addtable" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${Quotes}" var="qt">
                                                    <tr>

                                                        <td align="center"><input type="radio" name="tripid" value="${qt.tid}" checked="checked"/></td>
                                                        <td align="center">${qt.tname}</td>
                                                        <td align="center">${qt.from}</td>
                                                        <td align="center">${qt.to}</td>
                                                        <td align="center">${qt.quotation}</td>
                                                        <td align="center">${qt.cstid}</td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>

                                        <p> <input type="submit" value="Get Info" name="vst" /></p>
                                        </c:if>
                                </form>
                                </p>
                                <ul class="sb_menu">
                        ...
                        <div class="sidebar">
                            <div class="gadget">
                                ...
                                <ul class="sb_menu">
                                    ...
                                    <li  class="active"><a href="VQuotedTripServlet">View Quoted Trip</a></li>
