 ...
 */
public class VApprovedTripServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String str = "select T_ID,Trip_Name,From_Place,To_Place,Status from TripMaster where (Status='Approved' or Status='Invoiced') and Vendor_ID ='"+email+"'";
            ...
            con.close();
            RequestDispatcher rd = request.getRequestDispatcher("vapprovedtrip.jsp");
