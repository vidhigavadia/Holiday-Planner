 ...
 */
public class VBookedTripServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try {
            ...
            String str = "select T_ID,Trip_Name,From_Place,To_Place,Status from TripMaster where Status='Booked'and Vendor_ID= '"+email+"'" ;
            ...
            con.close();
            RequestDispatcher rd = request.getRequestDispatcher("vbookedtrip.jsp");
