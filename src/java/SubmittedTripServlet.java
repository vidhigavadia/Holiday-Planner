 ...
 */
public class SubmittedTripServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String str = "select T_ID,Trip_Name,From_Place,To_Place,Status from TripMaster where (Status='Submitted' or Status = 'Quoted') and Cust_ID='" + email + "'";
            ...
            con.close();
            RequestDispatcher rd = request.getRequestDispatcher("submittedtrip.jsp");
